...
const MOCK_PAIRED_VEHICLES: PairedVehicle[] = [
...
function buildClient(config: MGLConfig) {
  const isMock = config.mockMode !== false || !config.baseUrl;
...
export { buildClient, MOCK_BINDINGS, MOCK_TRANSACTIONS, MOCK_PAIRED_VEHICLES, MOCK_INVITE_CODES, MOCK_DRIVER };
